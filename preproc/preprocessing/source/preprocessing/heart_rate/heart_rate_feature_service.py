...
class HeartRateFeatureService(object):
    ...
    def build_from_collection(heart_rate_collection, valid_epochs):
        ...
        for epoch in valid_epochs:
            ...
            indices_in_range = HeartRateFeatureService.window_epoch(interpolated_timestamps, epoch)
            ...
            feature = heart_rate_values_in_range
            heart_rate_features.append(feature)
            
        heart_rate_features = np.array(heart_rate_features)
